...
3. If something isn't in the knowledge base, say warmly: "That's a great question! I don't have that info handy — but you can reach our team at rc.bombayairport3141@gmail.com or visit rcbombayairport.org 😊"
...
def get_ai_response(user_message, history):
    try:
        ...
        return "We're getting a lot of love right now! Try again in a few seconds 😄", None
        ...
        send_error_email(f"AI API error: {e.message}", user_message)
